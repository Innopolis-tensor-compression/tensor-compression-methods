...
from src.utils.benchmark.calculate_bounds import calculate_tucker_bounds
from src.utils.metrics_calculators import CompressionRatioTensorLyTuckerCalculator
...
def loss_function_tucker(
    ...
    try:
        ...
        compression_ratio = CompressionRatioTensorLyTuckerCalculator.calculate(tensor, (weight, factors)) / 100
    ...
    if verbose is True:
        ...
        class OptimizationLogger:
            ...
            def calculate_metrics(
                ...
                compression_ratio = (
                    CompressionRatioTensorLyTuckerCalculator.calculate(self.tensor, (weight, factors)) / 100
                )
                compression_penalty = (target_compression_ratio - compression_ratio) ** 2
